		...
		<div class="content-wrapper">
					...
					<tbody>
						...
						<c:forEach var="traveller" items="${orders.travellers}">
							...
							<tr>
								...
								<td><input type="text" size="10" name="name" value="${traveller.name }"></td>
								<td><input type="text" size="10" name="sex" value="${traveller.sex }"></td>
								<td><input type="text" size="20" name="phoneNum" value="${traveller.phoneNum }" ></td>
								<td><input type="text" size="15" name="credentialsTypeStr"  value="${traveller.credentialsTypeStr}" ></td>
								<td><input type="text" size="28" name="credentialsNum" value="${traveller.credentialsNum }" ></td>
							</tr>
						</c:forEach>
			...
			<!--联系人信息/--> <!--费用信息--> <c:if test="${orders.orderStatus==1}">
				<div class="panel panel-default">
					...
					<form action="${pageContext.request.contextPath}/orders/update" method="get" id="form">
						<input type="hidden" name="id" value="${orders.id}">
						<div class="col-md-1 title">支付方式</div>
						<div class="col-md-3 data text">在线支付-
							...
							</c:if><c:if test="${orders.payType==2}">
								<select name="payType">
									<option value="0">支付宝</option>
									<option value="1">微信</option>
						...
						<div class="col-md-1 title">支付状态</div>
						<div class="col-md-3 data text">在线支付-
						...
						<div class="col-md-1 title">金额</div>
						<div class="col-md-3 data text">￥${orders.product.productPrice}</div>
					</form>
			...
			<div class="box-tools text-center">
				<button type="button" class="btn bg-default"
						onclick="travellerUpdate();">提交</button>
				<button type="button" class="btn bg-default"
