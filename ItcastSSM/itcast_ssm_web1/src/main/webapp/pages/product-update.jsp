					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productNum"
								placeholder="${product.productNum}" value="${product.productNum}">
						</div>
							...
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									id="datepicker-a3" name="departureTimeStr"
									   placeholder="${product.departureTimeStr}" value="${product.departureTimeStr}">
							</div>
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="cityName"
								placeholder="${product.cityName}" value="${product.cityName}">
						</div>

						<div class="col-md-2 title">产品价格</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="${product.productPrice}"
