                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="删除" id="userdelete"
                                            onclick="userdelete();">
                            ...
                            <c:forEach items="${userList}" var="user">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/user/findByIdUpdate?id=${user.id}"
...
<script>
    ...
    $("#userdelete").click(function () {
        ...
        window.location.href = "${pageContext.request.contextPath}/user/delete?arr="+arr;
    });
</script>
</body>
