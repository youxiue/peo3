...
<body class="hold-transition skin-purple sidebar-mini">
									...
									<c:forEach items="${pageInfo.list}" var="orders">
										...
										<tr>
											...
											<td class="text-center">
												...
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/findByIdUpdate?id=${orders.id}'">编辑</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
	...
	<script>
        ...
        $("#delete").click(function () {
            ...
            window.location.href="${pageContext.request.contextPath}/orders/delete?ids="+ids;
        });
	</script>
</body>
